package com.example.foodfusion.fragments.bottomsheet
...
import com.example.foodfusion.databinding.FragmentMealBottomSheetBinding
    ...
    private fun onBottomSheetDialogClick() {
        binding.bottomSheet.setOnClickListener {
            if(mealName != null && mealThumb != null){
                val intet = Intent(activity,MealActivity::class.java)
                intet.apply {
